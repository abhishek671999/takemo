...
@Component({
  selector: 'app-post-recharge-payment',
  templateUrl: './post-recharge-payment.component.html',
  styleUrls: ['./post-recharge-payment.component.css']
})
export class PostRechargePaymentComponent {
  ...
  ngOnInit(){
    ...
    this._paymentService.getWalletTransactionStatus(this.transactionId).subscribe(
      data => {
